...
export type Category = DatabaseIdentifier & HierarchicalNode & HierarchicalTermNode & MenuItemLinkable & Node & TermNode & UniformResourceIdentifiable & {
  ...
  prisonerData?: Maybe<TermNode_Prisonerdata>;
  /** Connection between the Category type and the prisoner type */
  prisoners?: Maybe<CategoryToPrisonerConnection>;
...
/** The category type */
export type CategoryPrisonersArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<CategoryToPrisonerConnectionWhereArgs>;
};
...
/** Connection between the Category type and the prisoner type */
export type CategoryToPrisonerConnection = Connection & PrisonerConnection & {
  __typename?: 'CategoryToPrisonerConnection';
  /** Edges for the CategoryToPrisonerConnection connection */
  edges: Array<CategoryToPrisonerConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Prisoner>;
  /** Information about pagination in a connection. */
  pageInfo: CategoryToPrisonerConnectionPageInfo;
};

/** An edge in a connection */
export type CategoryToPrisonerConnectionEdge = Edge & PrisonerConnectionEdge & {
  __typename?: 'CategoryToPrisonerConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Prisoner;
...
/** Page Info on the &quot;CategoryToPrisonerConnection&quot; */
export type CategoryToPrisonerConnectionPageInfo = PageInfo & PrisonerConnectionPageInfo & WpPageInfo & {
  __typename?: 'CategoryToPrisonerConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the CategoryToPrisonerConnection connection */
export type CategoryToPrisonerConnectionWhereArgs = {
  /** Category ID */
  categoryId?: InputMaybe<Scalars['Int']['input']>;
  /** Array of category IDs, used to display objects from one category OR another */
  categoryIn?: InputMaybe<Array<InputMaybe<Scalars['ID']['input']>>>;
...
export type Comment = DatabaseIdentifier & Node & {
  ...
  parentId?: Maybe<Scalars['ID']['output']>;
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Преследуемый&quot; was set to Show in GraphQL. */
  prisonerData?: Maybe<Comment_Prisonerdata>;
  /** Connection between the Comment type and the Comment type */
...
export type Comment_Prisonerdata = AcfFieldGroup & {
  ...
  institutionshortnameparsed?: Maybe<Scalars['String']['output']>;
...
export type ContentNode = {
  ...
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Преследуемый&quot; was set to Show in GraphQL. */
  prisonerData?: Maybe<ContentNode_Prisonerdata>;
...
/** Input for the createPrisoner mutation. */
export type CreatePrisonerInput = {
  /** Set connections between the prisoner and categories */
  categories?: InputMaybe<PrisonerCategoriesInput>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The content of the object */
  content?: InputMaybe<Scalars['String']['input']>;
  ...
  /** The status of the object */
  status?: InputMaybe<PostStatusEnum>;
  /** Set connections between the prisoner and tags */
  tags?: InputMaybe<PrisonerTagsInput>;
  /** The title of the object */
  title?: InputMaybe<Scalars['String']['input']>;
};

/** The payload for the createPrisoner mutation. */
export type CreatePrisonerPayload = {
  __typename?: 'CreatePrisonerPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  prisoner?: Maybe<Prisoner>;
};
...
/** Input for the deletePrisoner mutation. */
export type DeletePrisonerInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars['Boolean']['input']>;
  /** The ID of the prisoner to delete */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']['input']>;
};

/** The payload for the deletePrisoner mutation. */
export type DeletePrisonerPayload = {
  __typename?: 'DeletePrisonerPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The ID of the deleted object */
  deletedId?: Maybe<Scalars['ID']['output']>;
...
export type Menu = DatabaseIdentifier & Node & {
  ...
  name?: Maybe<Scalars['String']['output']>;
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Преследуемый&quot; was set to Show in GraphQL. */
  prisonerData?: Maybe<Menu_Prisonerdata>;
...
export type MenuItem = DatabaseIdentifier & Node & {
  ...
  path?: Maybe<Scalars['String']['output']>;
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Преследуемый&quot; was set to Show in GraphQL. */
  prisonerData?: Maybe<MenuItem_Prisonerdata>;
...
export type MenuItemObjectUnion = Category | Page | Post | Prisoner | Tag;
...
export type Prisoner = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithExcerpt & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
   ...
   * @deprecated Deprecated in favor of the databaseId field
   */
  prisonerId: Scalars['Int']['output'];
  /** The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table. */
  slug?: Maybe<Scalars['String']['output']>;
  /** The current status of the object */
  status?: Maybe<Scalars['String']['output']>;
  /** Connection between the Prisoner type and the tag type */
  tags?: Maybe<PrisonerToTagConnection>;
  /** The template assigned to the node */
  template?: Maybe<ContentTemplate>;
  /** Connection between the Prisoner type and the TermNode type */
  terms?: Maybe<PrisonerToTermNodeConnection>;
  /** The title of the post. This is currently just the raw title. An amendment to support rendered title needs to be made. */
  title?: Maybe<Scalars['String']['output']>;
  /** The unique resource identifier path */
  uri?: Maybe<Scalars['String']['output']>;
...
/** The prisoner type */
export type PrisonerCategoriesArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<PrisonerToCategoryConnectionWhereArgs>;
};


/** The prisoner type */
export type PrisonerContentArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The prisoner type */
export type PrisonerEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The prisoner type */
export type PrisonerEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The prisoner type */
export type PrisonerExcerptArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The prisoner type */
export type PrisonerTagsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<PrisonerToTagConnectionWhereArgs>;
};


/** The prisoner type */
export type PrisonerTermsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<PrisonerToTermNodeConnectionWhereArgs>;
};


/** The prisoner type */
export type PrisonerTitleArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};

/** Set relationships between the prisoner to categories */
export type PrisonerCategoriesInput = {
  /** If true, this will append the category to existing related categories. If false, this will replace existing relationships. Default true. */
  append?: InputMaybe<Scalars['Boolean']['input']>;
  /** The input list of items to set. */
  nodes?: InputMaybe<Array<InputMaybe<PrisonerCategoriesNodeInput>>>;
};

/** List of categories to connect the prisoner to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export type PrisonerCategoriesNodeInput = {
  /** The description of the category. This field is used to set a description of the category if a new one is created during the mutation. */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the category. If present, this will be used to connect to the prisoner. If no existing category exists with this ID, no connection will be made. */
  id?: InputMaybe<Scalars['ID']['input']>;
  /** The name of the category. This field is used to create a new term, if term creation is enabled in nested mutations, and if one does not already exist with the provided slug or ID or if a slug or ID is not provided. If no name is included and a term is created, the creation will fallback to the slug field. */
  name?: InputMaybe<Scalars['String']['input']>;
  /** The slug of the category. If no ID is present, this field will be used to make a connection. If no existing term exists with this slug, this field will be used as a fallback to the Name field when creating a new term to connect to, if term creation is enabled as a nested mutation. */
...
/** Connection to prisoner Nodes */
export type PrisonerConnection = {
  /** A list of edges (relational context) between RootQuery and connected prisoner Nodes */
  edges: Array<PrisonerConnectionEdge>;
  /** A list of connected prisoner Nodes */
  nodes: Array<Prisoner>;
  /** Information about pagination in a connection. */
  pageInfo: PrisonerConnectionPageInfo;
};

/** Edge between a Node and a connected prisoner */
export type PrisonerConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The connected prisoner Node */
  node: Prisoner;
};

/** Page Info on the connected PrisonerConnectionEdge */
export type PrisonerConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
export type PrisonerTagsInput = {
  ...
  append?: InputMaybe<Scalars['Boolean']['input']>;
  /** The input list of items to set. */
  nodes?: InputMaybe<Array<InputMaybe<PrisonerTagsNodeInput>>>;
};

/** List of tags to connect the prisoner to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export type PrisonerTagsNodeInput = {
  /** The description of the tag. This field is used to set a description of the tag if a new one is created during the mutation. */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the tag. If present, this will be used to connect to the prisoner. If no existing tag exists with this ID, no connection will be made. */
  id?: InputMaybe<Scalars['ID']['input']>;
  /** The name of the tag. This field is used to create a new term, if term creation is enabled in nested mutations, and if one does not already exist with the provided slug or ID or if a slug or ID is not provided. If no name is included and a term is created, the creation will fallback to the slug field. */
  name?: InputMaybe<Scalars['String']['input']>;
  /** The slug of the tag. If no ID is present, this field will be used to make a connection. If no existing term exists with this slug, this field will be used as a fallback to the Name field when creating a new term to connect to, if term creation is enabled as a nested mutation. */
...
/** Connection between the Prisoner type and the category type */
export type PrisonerToCategoryConnection = CategoryConnection & Connection & {
  __typename?: 'PrisonerToCategoryConnection';
  /** Edges for the PrisonerToCategoryConnection connection */
  edges: Array<PrisonerToCategoryConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Category>;
  /** Information about pagination in a connection. */
  pageInfo: PrisonerToCategoryConnectionPageInfo;
};

/** An edge in a connection */
export type PrisonerToCategoryConnectionEdge = CategoryConnectionEdge & Edge & {
  __typename?: 'PrisonerToCategoryConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Category;
...
/** Page Info on the &quot;PrisonerToCategoryConnection&quot; */
export type PrisonerToCategoryConnectionPageInfo = CategoryConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'PrisonerToCategoryConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the PrisonerToCategoryConnection connection */
export type PrisonerToCategoryConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']['input']>;
...
/** Connection between the Prisoner type and the prisoner type */
export type PrisonerToPreviewConnectionEdge = Edge & OneToOneConnection & PrisonerConnectionEdge & {
  __typename?: 'PrisonerToPreviewConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Prisoner;
...
/** Connection between the Prisoner type and the tag type */
export type PrisonerToTagConnection = Connection & TagConnection & {
  __typename?: 'PrisonerToTagConnection';
  /** Edges for the PrisonerToTagConnection connection */
  edges: Array<PrisonerToTagConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Tag>;
  /** Information about pagination in a connection. */
  pageInfo: PrisonerToTagConnectionPageInfo;
};

/** An edge in a connection */
export type PrisonerToTagConnectionEdge = Edge & TagConnectionEdge & {
  __typename?: 'PrisonerToTagConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Tag;
...
/** Page Info on the &quot;PrisonerToTagConnection&quot; */
export type PrisonerToTagConnectionPageInfo = PageInfo & TagConnectionPageInfo & WpPageInfo & {
  __typename?: 'PrisonerToTagConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the PrisonerToTagConnection connection */
export type PrisonerToTagConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']['input']>;
...
/** Connection between the Prisoner type and the TermNode type */
export type PrisonerToTermNodeConnection = Connection & TermNodeConnection & {
  __typename?: 'PrisonerToTermNodeConnection';
  /** Edges for the PrisonerToTermNodeConnection connection */
  edges: Array<PrisonerToTermNodeConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<TermNode>;
  /** Information about pagination in a connection. */
  pageInfo: PrisonerToTermNodeConnectionPageInfo;
};

/** An edge in a connection */
export type PrisonerToTermNodeConnectionEdge = Edge & TermNodeConnectionEdge & {
  __typename?: 'PrisonerToTermNodeConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: TermNode;
...
/** Page Info on the &quot;PrisonerToTermNodeConnection&quot; */
export type PrisonerToTermNodeConnectionPageInfo = PageInfo & TermNodeConnectionPageInfo & WpPageInfo & {
  __typename?: 'PrisonerToTermNodeConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the PrisonerToTermNodeConnection connection */
export type PrisonerToTermNodeConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']['input']>;
...
export type RootMutation = {
  ...
  /** The createPrisoner mutation */
  createPrisoner?: Maybe<CreatePrisonerPayload>;
  ...
  /** The deletePrisoner mutation */
  deletePrisoner?: Maybe<DeletePrisonerPayload>;
  ...
  /** The updatePrisoner mutation */
  updatePrisoner?: Maybe<UpdatePrisonerPayload>;
...
/** The root mutation */
export type RootMutationCreatePrisonerArgs = {
  input: CreatePrisonerInput;
};
...
/** The root mutation */
export type RootMutationDeletePrisonerArgs = {
  input: DeletePrisonerInput;
};
...
/** The root mutation */
export type RootMutationUpdatePrisonerArgs = {
...
export type RootQuery = {
  ...
  /** An object of the prisoner Type.  */
  prisoner?: Maybe<Prisoner>;
  /**
   * A prisoner object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
...
/** The root entry point into the Graph */
export type RootQueryPrisonerArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']['input']>;
  id: Scalars['ID']['input'];
  idType?: InputMaybe<PrisonerIdType>;
};


/** The root entry point into the Graph */
export type RootQueryPrisonerByArgs = {
  id?: InputMaybe<Scalars['ID']['input']>;
  prisonerId?: InputMaybe<Scalars['Int']['input']>;
  slug?: InputMaybe<Scalars['String']['input']>;
  uri?: InputMaybe<Scalars['String']['input']>;
};
...
/** The root entry point into the Graph */
export type RootQueryPrisonersArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<RootQueryToPrisonerConnectionWhereArgs>;
};
...
/** Connection between the RootQuery type and the prisoner type */
export type RootQueryToPrisonerConnection = Connection & PrisonerConnection & {
  __typename?: 'RootQueryToPrisonerConnection';
  /** Edges for the RootQueryToPrisonerConnection connection */
  edges: Array<RootQueryToPrisonerConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Prisoner>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToPrisonerConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToPrisonerConnectionEdge = Edge & PrisonerConnectionEdge & {
  __typename?: 'RootQueryToPrisonerConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Prisoner;
...
/** Page Info on the &quot;RootQueryToPrisonerConnection&quot; */
export type RootQueryToPrisonerConnectionPageInfo = PageInfo & PrisonerConnectionPageInfo & WpPageInfo & {
  __typename?: 'RootQueryToPrisonerConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the RootQueryToPrisonerConnection connection */
export type RootQueryToPrisonerConnectionWhereArgs = {
...
export type Tag = DatabaseIdentifier & MenuItemLinkable & Node & TermNode & UniformResourceIdentifiable & {
  ...
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Преследуемый&quot; was set to Show in GraphQL. */
  prisonerData?: Maybe<TermNode_Prisonerdata>;
  /** Connection between the Tag type and the prisoner type */
  prisoners?: Maybe<TagToPrisonerConnection>;
  /** An alphanumeric identifier for the object unique to its type. */
  slug?: Maybe<Scalars['String']['output']>;
  /**
   * The id field matches the WP_Post-&gt;ID field.
...
/** The tag type */
export type TagPrisonersArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<TagToPrisonerConnectionWhereArgs>;
};
...
/** Connection between the Tag type and the prisoner type */
export type TagToPrisonerConnection = Connection & PrisonerConnection & {
  __typename?: 'TagToPrisonerConnection';
  /** Edges for the TagToPrisonerConnection connection */
  edges: Array<TagToPrisonerConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Prisoner>;
  /** Information about pagination in a connection. */
  pageInfo: TagToPrisonerConnectionPageInfo;
};

/** An edge in a connection */
export type TagToPrisonerConnectionEdge = Edge & PrisonerConnectionEdge & {
  __typename?: 'TagToPrisonerConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Prisoner;
...
/** Page Info on the &quot;TagToPrisonerConnection&quot; */
export type TagToPrisonerConnectionPageInfo = PageInfo & PrisonerConnectionPageInfo & WpPageInfo & {
  __typename?: 'TagToPrisonerConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the TagToPrisonerConnection connection */
export type TagToPrisonerConnectionWhereArgs = {
  /** Category ID */
  categoryId?: InputMaybe<Scalars['Int']['input']>;
  /** Array of category IDs, used to display objects from one category OR another */
  categoryIn?: InputMaybe<Array<InputMaybe<Scalars['ID']['input']>>>;
...
/** Input for the updatePrisoner mutation. */
export type UpdatePrisonerInput = {
  /** Set connections between the prisoner and categories */
  categories?: InputMaybe<PrisonerCategoriesInput>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
...
/** The payload for the updatePrisoner mutation. */
export type UpdatePrisonerPayload = {
  __typename?: 'UpdatePrisonerPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  prisoner?: Maybe<Prisoner>;
...
export type User = Commenter & DatabaseIdentifier & Node & UniformResourceIdentifiable & {
  ...
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Преследуемый&quot; was set to Show in GraphQL. */
  prisonerData?: Maybe<User_Prisonerdata>;
